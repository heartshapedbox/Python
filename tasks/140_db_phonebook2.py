...
class App():
    ...
    def show_menu(self):
        ...
        self.btn4 = customtkinter.CTkButton(self.menu_frame, text = 'Delete person from phone book', cursor = 'hand2', width = 200, command = lambda:self.show_remove_number_from_db())
