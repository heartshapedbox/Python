import os
os.chdir ("D:\Code\Python\Scraping\lesson2_practice3\data")
import re
import requests
import json
import csv
...
def get_parent_categories():
    ...
    with open("D:\Code\Python\Scraping\lesson2_practice3\index.html", "w", encoding="utf-8") as file:
        file.write(webpage)
    with open("D:\Code\Python\Scraping\lesson2_practice3\index.html", encoding="utf-8") as file:
    ...
    with open("D:\Code\Python\Scraping\lesson2_practice3\parent_categories\parent_categories.json", "w", encoding="utf-8") as file:
        json.dump(parent_categories, file, indent=4, ensure_ascii=False)
get_parent_categories()

def get_sub_categories():
    with open("D:\Code\Python\Scraping\lesson2_practice3\parent_categories\parent_categories.json", encoding="utf-8") as file:
    ...
    for parent_cat_name, parent_cat_url in par_cat.items():
        ...
        webpage=request.text
        with open(f"D:\Code\Python\Scraping\lesson2_practice3\\parent_categories\{count}_{parent_cat_name}.html", "w", encoding="utf-8") as file:
            file.write(webpage)
        with open(f"D:\Code\Python\Scraping\lesson2_practice3\\parent_categories\{count}_{parent_cat_name}.html", encoding="utf-8") as file:
            webpage_text=file.read()
        soup=BeautifulSoup(webpage_text, "lxml")
        ...
        count+=1
        with open("D:\Code\Python\Scraping\lesson2_practice3\sub_categories\sub_categories.json", "w", encoding="utf-8") as file:
            json.dump(sub_categories, file, indent=4, ensure_ascii=False)
get_sub_categories()

def get_all_pages_of_sub_categories():
    with open("D:\Code\Python\Scraping\lesson2_practice3\sub_categories\sub_categories.json", encoding="utf-8") as file:
    ...
    for sub_cat_name, sub_cat_url in sb_cat.items():
        ...
        webpage=request.text
        with open(f"D:\Code\Python\Scraping\lesson2_practice3\sub_categories\{sub_cat_page_num}_{sub_cat_name}.html", "w", encoding="utf-8") as file:
            file.write(webpage)
        with open(f"D:\Code\Python\Scraping\lesson2_practice3\sub_categories\{sub_cat_page_num}_{sub_cat_name}.html", encoding="utf-8") as file:
            webpage_text=file.read()
        soup=BeautifulSoup(webpage_text, "lxml")
        ...
        with open(f"D:\Code\Python\Scraping\lesson2_practice3\sub_categories\sub_categories_pages.json", "w", encoding="utf-8") as file:
            json.dump(sub_categories_pages, file, indent=4, ensure_ascii=False)
        sub_cat_page_num+=1
get_all_pages_of_sub_categories()

def get_books_data():
    with open("D:\Code\Python\Scraping\lesson2_practice3\sub_categories\sub_categories_pages.json", encoding="utf-8") as file:
