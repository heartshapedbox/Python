import os
os.chdir("D:\Code\Python\Scraping\lesson2_practice2\data")
import re
import requests
import csv
import json
...
with open("D:\Code\Python\Scraping\lesson2_practice2\index.html", "w", encoding="utf-8") as file:
    file.write(webpage)
with open("D:\Code\Python\Scraping\lesson2_practice2\index.html", encoding="utf-8") as file:
...
with open("D:\Code\Python\Scraping\lesson2_practice2\categories_list.json", "w", encoding="utf-8") as file:
    json.dump(categories_list, file, indent=4, ensure_ascii=False)
with open("D:\Code\Python\Scraping\lesson2_practice2\sub_categories_list.json", "w", encoding="utf-8") as file:
    json.dump(sub_categories_list, file, indent=4, ensure_ascii=False)
with open("D:\Code\Python\Scraping\lesson2_practice2\sub_categories_list.json", encoding="utf-8") as file:
